...
to [coc@universal-blue.org](mailto:coc@universal-blue.org).
...
Please note, negativo17 supports the initial Nvidia driver release available with each Fedora version as well as the latest version. Any intermittent versions are not maintained by negativo17 after they have been superceded with a new version.
